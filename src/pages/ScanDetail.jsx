...
const ScanDetail = () => {
  ...
  const steps = [
    { label: "Spidering", icon: <Bug size={16} strokeWidth={1.8} />, active: true },
    { label: "Mapping", icon: <Network size={16} strokeWidth={1.8} /> },
    { label: "Testing", icon: <FlaskConical size={16} strokeWidth={1.8} /> },
    { label: "Validating", icon: <ClipboardCheck size={16} strokeWidth={1.8} /> },
  ...
  return (
    <div className="min-h-screen dark:text-gray-200">
      ...
      {/* TOP SECTION */}
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-8 mb-3 transition-colors">
        <div className="flex gap-12 items-center">
          ...
          <div className="flex-1 flex flex-col">
                    ...
                    className={`w-12 h-12 rounded-full flex items-center justify-center border-2
                      ${
                        step.active
                          ...
                          : "bg-white dark:bg-gray-700 text-gray-400 dark:text-gray-300 border-gray-300 dark:border-gray-600"
                      }`}
                  >
                    {step.icon}
                  </div>
            ...
            <div className="flex justify-between items-center border-t-2 border-t-gray-300 dark:border-gray-600 pt-6 text-sm">
              {[
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm overflow-hidden transition-colors">
        ...
        <div className="grid grid-cols-3">
          ...
          <div className="col-span-2 border-r border-gray-300 dark:border-gray-700">
            ...
            <div className="flex border-b border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-700 px-6">
              {[
                ...
                <button
                  ...
                  className={`relative py-2 px-4 text-sm font-medium transition-colors
                    ${
                      activeTab === tab.id
                        ? "text-teal-600"
                        : "text-gray-500 dark:text-gray-300 hover:text-gray-700 dark:hover:text-teal-600"
                    }`}
                >
                  {tab.label}
                  {activeTab === tab.id && (
            ...
            <div
              className="p-6 text-sm text-gray-700 dark:text-gray-300 space-y-3 overflow-y-auto"
              style={{
                fontFamily:
          ...
          <div className="col-span-1 bg-gray-50 dark:bg-gray-900">
            ...
            <div className="px-2 py-2 flex flex-col gap-2">
              {findings.map((item, i) => (
                <div
                  key={i}
                  className="bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-xl p-4"
                >
